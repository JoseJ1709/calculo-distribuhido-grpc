...
class CalculationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CalculateSum = channel.unary_unary(
                '/calculation.CalculationService/CalculateSum',
...
def add_CalculationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'calculation.CalculationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('calculation.CalculationService', rpc_method_handlers)
